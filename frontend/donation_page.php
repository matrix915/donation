...
<body>
    <form action="paypal_checkout.php" method="post" enctype="multipart/form-data">
        ...
        <div class="left_side">
            ...
            <div class="middle_div">
                ...
                onClick="triggerClick()" id="profileDisplay"> -->
                    <video id="myvideo" style="margin-top: 36px;margin-left: 160px;" width='400' height='400' controls onClick="triggerClick()" id="profileDisplay">
                        <source src='upload/sample-mp4-file.mp4' type='video/mp4'>
                    </video>
                    ...
                    <input type="text" class="custormer" id="custormer" placeholder="Enter CustormerName" name="custormer_name" style ="width:200px;height:30px;margin-left:200px;"required>
                </div>
            </div>
        ...
        <div class="right_side">
            ...
            <div class="influence_area" style="width:400px;height:100px;margin-top:50px;float:right;">
                ...
                <div class="influence_part" style="height:135px;width:100%;background:white;">
                    <img id="profile_image1" src="../backend/upload_images/<?php echo $user_info['user_image']; ?>" width=74 height=74 style="display:inline-block;border-radius:50%;margin-top: 25px;" />
                    ...
                    <!-- <a href="paypal_checkout.php" class="btn video_submit">Submit</a> -->
                    <input type="submit" value="Submit" class="btn video_submit">
                </div>
            </div>
        </div>
    </form>
